...
struct FemtoDreamProducerTaskReso {
 ...
 // cuts and object for v0 2
  FemtoDreamV0Selection v0CutsPart2;
  Configurable<std::vector<float>> confV0Part2Sign{FemtoDreamV0Selection::getSelectionName(femto_dream_v0_selection::kV0Sign, "confV0Part2"), std::vector<float>{-1, 1}, FemtoDreamV0Selection::getSelectionHelper(femto_dream_v0_selection::kV0Sign, "V0 selection: ")};
  Configurable<std::vector<float>> confV0Part2PtMin{FemtoDreamV0Selection::getSelectionName(femto_dream_v0_selection::kV0pTMin, "confV0Part2"), std::vector<float>{0.3f, 0.4f, 0.5f}, FemtoDreamV0Selection::getSelectionHelper(femto_dream_v0_selection::kV0pTMin, "V0 selection: ")};
  Configurable<std::vector<float>> confV0Part2PtMax{FemtoDreamV0Selection::getSelectionName(femto_dream_v0_selection::kV0pTMax, "confV0Part2"), std::vector<float>{3.3f, 3.4f, 3.5f}, FemtoDreamV0Selection::getSelectionHelper(femto_dream_v0_selection::kV0pTMax, "V0 selection: ")};
  Configurable<std::vector<float>> confV0Part2EtaMax{FemtoDreamV0Selection::getSelectionName(femto_dream_v0_selection::kV0etaMax, "confV0Part2"), std::vector<float>{0.8f, 0.7f, 0.9f}, FemtoDreamV0Selection::getSelectionHelper(femto_dream_v0_selection::kV0etaMax, "V0 selection: ")};
  Configurable<std::vector<float>> confV0Part2DCADaughMax{FemtoDreamV0Selection::getSelectionName(femto_dream_v0_selection::kV0DCADaughMax, "confV0Part2"), std::vector<float>{1.2f, 1.5f}, FemtoDreamV0Selection::getSelectionHelper(femto_dream_v0_selection::kV0DCADaughMax, "V0 selection: ")};
  Configurable<std::vector<float>> confV0Part2CPAMin{FemtoDreamV0Selection::getSelectionName(femto_dream_v0_selection::kV0CPAMin, "confV0Part2"), std::vector<float>{0.99f, 0.995f}, FemtoDreamV0Selection::getSelectionHelper(femto_dream_v0_selection::kV0CPAMin, "V0 selection: ")};
  Configurable<std::vector<float>> confV0Part2TranRadMin{FemtoDreamV0Selection::getSelectionName(femto_dream_v0_selection::kV0TranRadMin, "confV0Part2"), std::vector<float>{0.2f}, FemtoDreamV0Selection::getSelectionHelper(femto_dream_v0_selection::kV0TranRadMin, "V0 selection: ")};
  Configurable<std::vector<float>> confV0Part2TranRadMax{FemtoDreamV0Selection::getSelectionName(femto_dream_v0_selection::kV0TranRadMax, "confV0Part2"), std::vector<float>{100.f}, FemtoDreamV0Selection::getSelectionHelper(femto_dream_v0_selection::kV0TranRadMax, "V0 selection: ")};
  Configurable<std::vector<float>> confV0Part2DecVtxMax{FemtoDreamV0Selection::getSelectionName(femto_dream_v0_selection::kV0DecVtxMax, "confV0Part2"), std::vector<float>{100.f}, FemtoDreamV0Selection::getSelectionHelper(femto_dream_v0_selection::kV0DecVtxMax, "V0 selection: ")};

  Configurable<float> confV0Part2InvMassLowLimit{"confV0Part2InvMassLowLimit", 1.05, "Lower limit of the V0 invariant mass"};
  Configurable<float> confV0Part2InvMassUpLimit{"confV0Part2InvMassUpLimit", 1.30, "Upper limit of the V0 invariant mass"};
  Configurable<bool> confV0Part2RejectKaons{"confV0Part2RejectKaons", false, "Switch to reject kaons"};
  Configurable<bool> confV0Part2RejectLambdas{"confV0Part2RejectLambdas", false, "Switch to reject lambdas (if mother is kaon)"};
  Configurable<float> confV0Part2InvKaonMassLowLimit{"confV0Part2InvKaonMassLowLimit", 0.48, "Lower limit of the V0 invariant mass for Kaon rejection"};
  Configurable<float> confV0Part2InvKaonMassUpLimit{"confV0Part2InvKaonMassUpLimit", 0.515, "Upper limit of the V0 invariant mass for Kaon rejection"};
  Configurable<bool> confV0Part2MotherIsLambda{"confV0Part2MotherIsLambda", true, "True: Lambda, False: K0Short"};

  Configurable<std::vector<float>> confChildPart2Sign{"confChildSign", std::vector<float>{-1, 1}, "V0 Child sel: Charge"};
  Configurable<std::vector<float>> confChildPart2EtaMax{"confChildEtaMax", std::vector<float>{0.8f}, "V0 Child sel: max eta"};
  Configurable<std::vector<float>> confChildPart2TPCnClsMin{"confChildTPCnClsMin", std::vector<float>{80.f, 70.f, 60.f}, "V0 Child sel: Min. nCls TPC"};
  Configurable<std::vector<float>> confChildPart2DCAMin{"confChildDCAMin", std::vector<float>{0.05f, 0.06f}, "V0 Child sel:  Max. DCA Daugh to PV (cm)"};
  Configurable<std::vector<float>> confChildPart2PIDnSigmaMax{"confChildPIDnSigmaMax", std::vector<float>{5.f, 4.f}, "V0 Child sel: Max. PID nSigma TPC"};
  Configurable<std::vector<int>> confChildPart2PIDspecies{"confChildPIDspecies", std::vector<int>{o2::track::PID::Pion, o2::track::PID::Proton}, "V0 Child sel: Particles species for PID"};
  ...
  void init(InitContext&)
  {
    ...
    if (confIsActivateV0Part2) {
      v0CutsPart2.setSelection(confV0Part2Sign, femto_dream_v0_selection::kV0Sign, femtoDreamSelection::kEqual);
      v0CutsPart2.setSelection(confV0Part2PtMin, femto_dream_v0_selection::kV0pTMin, femtoDreamSelection::kLowerLimit);
      v0CutsPart2.setSelection(confV0Part2PtMax, femto_dream_v0_selection::kV0pTMax, femtoDreamSelection::kUpperLimit);
      v0CutsPart2.setSelection(confV0Part2EtaMax, femto_dream_v0_selection::kV0etaMax, femtoDreamSelection::kAbsUpperLimit);
      v0CutsPart2.setSelection(confV0Part2DCADaughMax, femto_dream_v0_selection::kV0DCADaughMax, femtoDreamSelection::kUpperLimit);
      v0CutsPart2.setSelection(confV0Part2CPAMin, femto_dream_v0_selection::kV0CPAMin, femtoDreamSelection::kLowerLimit);
      v0CutsPart2.setSelection(confV0Part2TranRadMin, femto_dream_v0_selection::kV0TranRadMin, femtoDreamSelection::kLowerLimit);
      v0CutsPart2.setSelection(confV0Part2TranRadMax, femto_dream_v0_selection::kV0TranRadMax, femtoDreamSelection::kUpperLimit);
      v0CutsPart2.setSelection(confV0Part2DecVtxMax, femto_dream_v0_selection::kV0DecVtxMax, femtoDreamSelection::kUpperLimit);
      v0CutsPart2.setChildCuts(femto_dream_v0_selection::kPosTrack, confChildPart2Sign, femtoDreamTrackSelection::kSign, femtoDreamSelection::kEqual);
      v0CutsPart2.setChildCuts(femto_dream_v0_selection::kPosTrack, confChildPart2EtaMax, femtoDreamTrackSelection::kEtaMax, femtoDreamSelection::kAbsUpperLimit);
      v0CutsPart2.setChildCuts(femto_dream_v0_selection::kPosTrack, confChildPart2TPCnClsMin, femtoDreamTrackSelection::kTPCnClsMin, femtoDreamSelection::kLowerLimit);
      v0CutsPart2.setChildCuts(femto_dream_v0_selection::kPosTrack, confChildPart2DCAMin, femtoDreamTrackSelection::kDCAMin, femtoDreamSelection::kAbsLowerLimit);
      v0CutsPart2.setChildCuts(femto_dream_v0_selection::kPosTrack, confChildPart2PIDnSigmaMax, femtoDreamTrackSelection::kPIDnSigmaMax, femtoDreamSelection::kAbsUpperLimit);
      
      v0CutsPart2.setChildCuts(femto_dream_v0_selection::kNegTrack, confChildPart2Sign, femtoDreamTrackSelection::kSign, femtoDreamSelection::kEqual);
      v0CutsPart2.setChildCuts(femto_dream_v0_selection::kNegTrack, confChildPart2EtaMax, femtoDreamTrackSelection::kEtaMax, femtoDreamSelection::kAbsUpperLimit);
      v0CutsPart2.setChildCuts(femto_dream_v0_selection::kNegTrack, confChildPart2TPCnClsMin, femtoDreamTrackSelection::kTPCnClsMin, femtoDreamSelection::kLowerLimit);
      v0CutsPart2.setChildCuts(femto_dream_v0_selection::kNegTrack, confChildPart2DCAMin, femtoDreamTrackSelection::kDCAMin, femtoDreamSelection::kAbsLowerLimit);
      v0CutsPart2.setChildCuts(femto_dream_v0_selection::kNegTrack, confChildPart2PIDnSigmaMax, femtoDreamTrackSelection::kPIDnSigmaMax, femtoDreamSelection::kAbsUpperLimit);
      v0CutsPart2.setChildPIDSpecies(femto_dream_v0_selection::kPosTrack, confChildPart2PIDspecies);
      v0CutsPart2.setChildPIDSpecies(femto_dream_v0_selection::kNegTrack, confChildPart2PIDspecies);
      v0CutsPart2.init<aod::femtodreamparticle::ParticleType::kV0, aod::femtodreamparticle::ParticleType::kV0Child, aod::femtodreamparticle::cutContainerType>(&qaRegistryV0, &v0Registry);
      v0CutsPart2.setInvMassLimits(confV0Part2InvMassLowLimit, confV0Part2InvMassUpLimit);
      v0CutsPart2.setIsMother(false);

      v0CutsPart2.setChildRejectNotPropagatedTracks(femto_dream_v0_selection::kPosTrack, confTrkRejectNotPropagated);
      v0CutsPart2.setChildRejectNotPropagatedTracks(femto_dream_v0_selection::kNegTrack, confTrkRejectNotPropagated);
      
      v0CutsPart2.setnSigmaPIDOffsetTPC(Track.confTrkPIDnSigmaOffsetTPC);
      v0CutsPart2.setChildnSigmaPIDOffset(femto_dream_v0_selection::kPosTrack, Track.confTrkPIDnSigmaOffsetTPC, Track.confTrkPIDnSigmaOffsetTOF);
      v0CutsPart2.setChildnSigmaPIDOffset(femto_dream_v0_selection::kNegTrack, Track.confTrkPIDnSigmaOffsetTPC, Track.confTrkPIDnSigmaOffsetTOF);
