...
struct femtoDreamProducerTask {
  ...
  template <bool isMC, bool useCentrality, bool analysePbPb, typename CascadeType, typename V0Type, typename TrackType, typename CollisionType>
  void fillCollisionsAndTracksAndV0AndCascade(CollisionType const& col, TrackType const& tracks, V0Type const& fullV0s, CascadeType const& fullCascades)
  {
                ...
                o2::aod::CascDatas const& fullCascades)
  {
    ...
    // fill the tables
    fillCollisionsAndTracksAndV0AndCascade<false, true, false>(col, tracks, fullV0s, fullCascades);
  }
                             ...
                             o2::aod::CascDatas const& fullCascades)
  {
    ...
    initCCDB_Mag_Trig(col.bc_as<aod::BCsWithTimestamps>());
    // fill the tables
    fillCollisionsAndTracksAndV0AndCascade<false, false, false>(col, tracks, fullV0s, fullCascades);
  }
