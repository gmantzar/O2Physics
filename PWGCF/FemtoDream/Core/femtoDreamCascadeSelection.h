  ...
  : public FemtoDreamObjectSelection<float, femtoDreamCascadeSelection::CascadeSel>
{
 public:
  ...
  template <int cutstage = 0, o2::aod::femtodreamparticle::ParticleType part, o2::aod::femtodreamparticle::ParticleType daugh, o2::aod::femtodreamparticle::ParticleType back, typename Col, typename Casc, typename Track>
...
template <int cutstage, o2::aod::femtodreamparticle::ParticleType part, o2::aod::femtodreamparticle::ParticleType daugh, o2::aod::femtodreamparticle::ParticleType bach, typename Col, typename Casc, typename Track>
void FemtoDreamCascadeSelection::fillQA(Col const& col, Casc const& casc, Track const& posTrack, Track const& negTrack, Track const& bachTrack)
{
  ...
  if (mQAHistogramRegistry) {
    ...
    PosDaughTrack.fillQA<daugh, aod::femtodreamparticle::TrackType::kPosChild, false, cutstage>(posTrack);
    NegDaughTrack.fillQA<daugh, aod::femtodreamparticle::TrackType::kNegChild, false, cutstage>(negTrack);
    BachDaughTrack.fillQA<bach, aod::femtodreamparticle::TrackType::kBachelor, false, cutstage>(bachTrack);
  }
}
