...
struct femtoDreamPairTaskCascadeCascade {
  ...
  void init(InitContext&)
  {
    ...
    begChildHistosPartOne.init(&Registry, Binning.multTempFit, Option.Dummy, Binning.pTCascadeChild, Option.Dummy, Option.Dummy, Binning.TempFitVarCascadeChild, Option.Dummy, Option.Dummy, Option.Dummy, Option.Dummy, Option.Dummy, Option.Dummy, false, 0);
    ...
    begChildHistosPartTwo.init(&Registry, Binning.multTempFit, Option.Dummy, Binning.pTCascadeChild, Option.Dummy, Option.Dummy, Binning.TempFitVarCascadeChild, Option.Dummy, Option.Dummy, Option.Dummy, Option.Dummy, Option.Dummy, Option.Dummy, false, 0);
  ...
  void doSameEvent(PartitionType& SliceCascade1, PartitionType& SliceCascade2, TableTracks const& parts, Collision const& col)
  {
    ...
    for (auto const& casc : SliceCascade1) {
      ...
      const auto& bachChil1 = parts.iteratorAt(casc.index() - 1);
